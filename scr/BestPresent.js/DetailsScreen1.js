  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#FCF6F7', padding: 10 }}>
      <View style={{ flex: 0.03, padding: 20 }}>
        ...
        <Image
          style={{ position: 'absolute', left: 5, height: 45, width: 45, paddingHorizontal: 20, }}
          source={require('../assets/apps.png')} />
      </View>
      <Image source={{ uri: item.image }} style={{ width: 396, resizeMode: 'contain', height: 283}} />
      ...
      <View style={{ flex: 1, justifyContent: 'flex-end' }}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('MyCart1', { item })}
        >
